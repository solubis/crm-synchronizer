...
Ext.util.Observable = Ext.extend(Object, {
    ...
    constructor: function(config) {
        ...
        if (this.name) console.log(this.name + ' -> constructor (Observable)');
...
Ext.util.Format = {
    ...
    format: function(format) {
        ...
        return format.replace(Ext.util.Format.formatRe,
        function(m, i) {
            return args[i];
        });
    },
...
Ext.ModelMgr = new Ext.AbstractManager({
    ...
    createAssociations: function(associations, name) {
        ...
        associationsMC = new Ext.util.MixedCollection(false,
    ...
    createFields: function(fields) {
        ...
        fieldsMC = new Ext.util.MixedCollection(false,
        function(field) {
            return field.name;
        });
    ...
    createRequestCallback: function(request, operation, callback, scope) {
        ...
        return function(options, success, response) {
            if (success === true) {
                ...
                length = records.length,
                mc = new Ext.util.MixedCollection(true,
                function(r) {
                    return r.getId();
                }),
                record,
...
Ext.Component = Ext.extend(Ext.lib.Component, {
    ...
    initComponent: function() {
       ...
       if (this.name) console.log(this.name + ' -> initComponent');
...
Ext.MessageBox = Ext.extend(Ext.Sheet, {
    ...
    show: function(config) {
        ...
        Ext.each([].concat(config.buttons || Ext.MessageBox.OK),
        function(button) {
            if (button) {
                bs.push(
                Ext.applyIf({
